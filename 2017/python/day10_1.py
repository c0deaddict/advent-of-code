...
# - The current position moves forward by the length plus the skip size, a total of 5, causing it not to move because
#    it wraps around: 4 3 0 [1] 2. The skip size increases to 2.
#
