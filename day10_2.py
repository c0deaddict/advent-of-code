...
# 31, 73, 47, 23. For example, if you are given 1,2,3, your final sequence of lengths should be 49,44,50,44,51,17,31,73,
# 47,23 (the ASCII codes from the input string combined with the standard length suffix values).
#
